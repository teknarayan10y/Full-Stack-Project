    ...
    <div className="home">
      ...
      <div className="property-types-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">Browse different types of accommodations</p>
        </div>
        <div className="property-types-grid">
          <div className="property-type-card" onClick={() => navigate('/hotels', { state: { ...searchParams, type: 'Hotel' } })}>
            <FaHotel className="property-type-icon" />
            <span>Hotels</span>
          </div>
          <div className="property-type-card" onClick={() => navigate('/hotels', { state: { ...searchParams, type: 'Resort' } })}>
            <FaUmbrellaBeach className="property-type-icon" />
            <span>Resorts</span>
          </div>
          <div className="property-type-card" onClick={() => navigate('/hotels', { state: { ...searchParams, type: 'Apartment' } })}>
            <FaHotel className="property-type-icon" />
            <span>Apartments</span>
          </div>
          <div className="property-type-card" onClick={() => navigate('/hotels', { state: { ...searchParams, type: 'Villa' } })}>
            <FaHotel className="property-type-icon" />
            <span>Villas</span>
          </div>
        </div>
      ...
      <div className="newsletter-section">
        <div className="newsletter-container">
          ...
          <p>Get the latest travel deals and updates delivered to your inbox</p>
